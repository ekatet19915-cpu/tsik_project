...
import com.study.client.model.TaskDto;
...
public class TasksController {
    ...
    @FXML
    private ListView<TaskDto> openListView;

    @FXML
    private ListView<TaskDto> inProgressListView;

    @FXML
    private ListView<TaskDto> doneListView;
    ...
    private void loadTasks() {
        new Thread(() -> {
            try {
                List<TaskDto> tasks = taskService.getTasks(groupId);
                Platform.runLater(() -> {
